...
if __name__ == "__main__":
    ...
    parser.add_argument("--e_ckpt", type=str, default='/media/user1/38e499de-0c47-4e4b-8da7-cbf7c595d87c/Aravind_data/codes/FSLSD_HiRes-main_new/CELEBA-HQ-1024.pt')
    ...
    _dirs = ['./test/swapped/','./test/fuse/','./test/source/','./test/target/']
